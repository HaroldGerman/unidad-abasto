...
* [cite_start]**Gestión de Compras:** El proceso de solicitud a proveedores, recepción de proformas y aprobación por la dirección administrativa es propenso a demoras debido al flujo físico de documentos[cite: 6, 7].
...
* [cite_start]**Control de Almacén Inteligente:** Actualización automática del **Kardex digital**, permitiendo la creación inmediata de registros para nuevos productos ingresados[cite: 15, 16].
